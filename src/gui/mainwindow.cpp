...
MainWindow::MainWindow(QWidget* parent)
    ...
    setWindowTitle("AI Crypto Miner v1.0 [Qt6/OpenCL]");
...
void MainWindow::onStartClicked() {
    ...
    // In a real implementation, we'd spawn workers here
    // workers.push_back(std::make_unique<core::CpuWorker>(4));
    // workers[0]->start();
...
void MainWindow::runAI() {
    ...
    float opt_intensity;
    int opt_threads;
    aiEngine->predictOptimalSettings(75.0f, opt_intensity, opt_threads);

    std::cout << "[GUI] AI applied optimization to hardware..." << std::endl;
}
